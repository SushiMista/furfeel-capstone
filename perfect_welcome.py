...
# Make sure auth_pattern_background is imported
...
perfect_welcome = """class WelcomePage extends StatefulWidget {
...
# CAREFUL: find the first occurrence of class SignUpPage so we don't delete it
...
if start_idx != -1 and end_idx != -1:
    new_content = content[:start_idx] + perfect_welcome + content[end_idx:]
    with open('apps/mobile/lib/screens/auth/welcome_page.dart', 'w') as f:
        f.write(new_content)
    print("Successfully injected perfect WelcomePage!")
else:
