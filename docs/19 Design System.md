...
>
> Note `accent-ink` is `#0F766E`, not the `calm` foreground `#0C7C6F` it resembles — the latter measures 4.48:1 on `accent-soft` and fails AA. Verify, don't eyeball (ADR-021).
