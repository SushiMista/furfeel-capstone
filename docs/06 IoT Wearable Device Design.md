...
> Body temperature sensing was dropped (ADR-012) — FurFeel doesn't promote invasive procedures to gather stress data, so the harness only carries non-invasive wearable/environmental sensors.
