...
## ADR-021: Extend Palette A Rather Than Adopt the Mood Board's Warm Palette
...
## ADR-022: Generate the Illustration Set as One Flat-Vector System, Tinted from Tokens
Status: Accepted (2026-08-01)
...
## ADR-023: Immersive Status Hero + Per-Metric Chart Colour (owner Home)
