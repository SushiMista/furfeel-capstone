...
> Body temperature was removed as a classifier input and data point (ADR-012): FurFeel doesn't promote invasive procedures to gather stress data, so only non-invasive wearable/environmental signals are collected.
