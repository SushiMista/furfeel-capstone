...
> Paste the block below into Claude Code (or any agent working in this repo) when applying the redesign to a screen. It is deliberately self-contained. Keep it in sync with `19 Design System`, `21 Redesign Plan`, and ADR-021.
