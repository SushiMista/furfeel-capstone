...
Teal accent family (`accentStrong` / `accentInk` / `accentSoft`), status `mid` chart stops, cool `tint` set, warm demotion. Generator, Tailwind, Dart, and Android outputs all updated; contrast test extended. See **ADR-022**.
...
## Linked notes
- [[19 Design System]]
- [[02 Architecture Decisions]] (ADR-022, ADR-024)
